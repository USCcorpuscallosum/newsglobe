public class PointDrawable extends Drawable {
  ...
  private color col;
	...
	@Override
	public void draw() {
    float xPixelCoordinate = ((news.getGpsCoordinate().getLongitude() + 180) * (pixelWidth / 360.0));
		float yPixelCoordinate = ((-news.getGpsCoordinate().getLatitude() + 90) * (pixelHeight / 180.0));
